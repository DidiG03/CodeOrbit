...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  return (
    <div
      ...
      style={isFixed ? { pointerEvents: 'none' } : {}}
    >
      <div
        className={(className ? className + ' ' : '') + 'staggered-menu-wrapper relative w-full h-full z-40'}
        style={accentColor || open ? ({ ['--sm-accent' as any]: accentColor, pointerEvents: open ? 'auto' : 'none' } as React.CSSProperties) : undefined}
...
.sm-scope .staggered-menu-wrapper[data-open] { z-index: 100; }
